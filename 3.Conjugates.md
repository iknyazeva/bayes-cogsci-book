...
- {doc}`4.ConjugatePriors` — Detailed derivations for Beta-Bernoulli and Gamma-Poisson conjugate pairs
- {doc}`4.PosteriorPredictiveDistribution` — Predicting future observations after seeing data
- {doc}`4.PriorPredictiveDistribution` — Predicting observations before seeing data
```
