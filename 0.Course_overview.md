...
Welcome to **Bayesian Analysis of Empirical Data**. This course equips students and researchers with theoretical foundations and computational tools to model uncertainty, structure hierarchical data, and make principled inferences from empirical data across the social, cognitive, and behavioural sciences.
