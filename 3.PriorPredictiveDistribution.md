...
```{seealso}
- {doc}`3.PosteriorPredictiveDistribution` — Predicting future data *after* observing evidence
- {doc}`3.ConjugatePriors` — The conjugate prior framework that enables closed-form predictive distributions
