...
```{seealso}
- {doc}`3.ConjugatePriors` — Derivation of Beta-Bernoulli and Gamma-Poisson conjugate posteriors
- {doc}`3.PriorPredictiveDistribution` — Predicting data *before* observing any evidence
