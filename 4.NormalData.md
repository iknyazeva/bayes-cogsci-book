...
1. **Posterior for $\sigma^2$ given $Y$**:
...
Here, $\bar{Y}$ is the sample mean of the data, and the posterior mean can be written as a **weighted average** of the prior mean $M$ and the data mean $\bar{Y}$.
