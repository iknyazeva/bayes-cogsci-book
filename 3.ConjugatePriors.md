...
```{seealso}
- {doc}`3.PosteriorPredictiveDistribution` — Using the posterior to predict future observations
- {doc}`3.PriorPredictiveDistribution` — Making predictions before observing data
